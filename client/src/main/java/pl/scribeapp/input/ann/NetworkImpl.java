package pl.scribeapp.input.ann;
...
import pl.scribeapp.input.classificator.ClassificationResult;
import pl.scribeapp.input.classificator.ClassificationResult.Label;
import pl.scribeapp.input.classificator.Classificator;
...
public class NetworkImpl implements Network {
	 ...
	 * @see pl.scribeapp.input.ann.Network#load(java.io.InputStream)
	 */
	@Override
	 ...
	 * @see pl.scribeapp.input.ann.Network#save(java.io.OutputStream)
	 */
	@Override
	 ...
	 * @see pl.scribeapp.input.ann.Network#getTopology()
	 */
	@Override
