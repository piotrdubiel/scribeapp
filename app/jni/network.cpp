...
//
//extern "C" {
//int Java_pl_scribeapp_input_ann_NativeNetwork_load(JNIEnv* env, jobject thiz,jstring filename);
//void Java_pl_scribeapp_input_ann_NativeNetwork_close(JNIEnv* env, jobject thiz,jint net);
//jfloatArray Java_pl_scribeapp_input_ann_NativeNetwork_answer(JNIEnv* env, jobject thiz, jfloatArray in);
//};
//
