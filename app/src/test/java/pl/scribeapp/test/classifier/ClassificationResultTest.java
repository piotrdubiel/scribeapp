package pl.scribeapp.test.classifier;
...
import pl.scribeapp.classifier.ClassificationResult.LabelComparator;
...
public class ClassificationResultTest {
	...
	public void testGetLabels() {
		...
		// when
		ClassificationResult cr = new ClassificationResult(in, Classifier.DIGIT);
	...
	public void testCombineSameType() throws Exception {
		...
		// when
		ClassificationResult A = new ClassificationResult(a, Classifier.DIGIT);
		ClassificationResult B = new ClassificationResult(b, Classifier.DIGIT);
	...
	public void testCombineDifferentType() throws Exception {
		...
		// when
		ClassificationResult A = new ClassificationResult(a, Classifier.SMALL_ALPHA);
		ClassificationResult B = new ClassificationResult(b, Classifier.SMALL_ALPHA | Classifier.CAPITAL_ALPHA | Classifier.GROUP);
